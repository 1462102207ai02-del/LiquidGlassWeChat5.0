...
static void MMApplyLiquidGlassOverlay(UIView *view, BOOL capsuleStyle) {
    ...
    if (capsuleStyle) {
        overlayLayer.colors = @[
            ...
            (__bridge id)[UIColor colorWithRed:(228.0/255.0) green:(238.0/255.0) blue:(252.0/255.0) alpha:(MMIsDark(view.traitCollection) ? 0.04 : 0.12)].CGColor,
        ...
        overlayLayer.colors = @[
            (__bridge id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:(MMIsDark(view.traitCollection) ? 0.06 : 0.11)].CGColor,
            (__bridge id)[UIColor colorWithRed:(220.0/255.0) green:(232.0/255.0) blue:(248.0/255.0) alpha:(MMIsDark(view.traitCollection) ? 0.02 : 0.08)].CGColor,
...
static void MMApplyLiquidGlass(UIView *view, BOOL capsuleStyle) {
    ...
    if (capsuleStyle) {
        ...
        core.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:(dark ? 0.14 : 0.34)];
    } else {
        UIColor *bgTint = MMBackgroundTintColor(view.traitCollection);
        CGFloat r = 1.0, g = 1.0, b = 1.0, a = 1.0;
        [bgTint getRed:&r green:&g blue:&b alpha:&a];
        core.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:(dark ? 0.20 : 0.52)];
    }
    ...
    if (capsuleStyle) {
        ...
        moving.colors = @[
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:0.0].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:(dark ? 0.10 : 0.18)].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:0.0].CGColor
        ];
        ...
        topLine.colors = @[
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:(dark ? 0.24 : 0.56)].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:(dark ? 0.05 : 0.10)].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:0.0].CGColor
        ];
    ...
    CGFloat outerAlpha = dark ? 0.20 : 0.52;
    CGFloat innerAlpha = dark ? 0.18 : 0.16;
    CGFloat outerWidth = 0.94;
    CGFloat innerWidth = 0.18;
    if (capsuleStyle) {
        outerAlpha = dark ? 0.18 : 0.46;
        innerAlpha = dark ? 0.16 : 0.14;
        outerWidth = 0.86;
        innerWidth = 0.16;
    }
    ...
    view.layer.shadowColor = [UIColor colorWithWhite:0.0 alpha:(capsuleStyle ? (dark ? 0.03 : 0.012) : (dark ? 0.04 : 0.012))].CGColor;
...
static UIColor *MMBackgroundTintColor(UITraitCollection *trait) {
    return MMColorFromStored(@"mm_bg_color", trait, MMIsDark(trait) ? MMRGBA(90, 98, 110, 1.0) : MMRGBA(255, 255, 255, 1.0));
}

static UIColor *MMCapsuleTintColor(UITraitCollection *trait) {
    return MMColorFromStored(@"mm_capsule_color", trait, MMIsDark(trait) ? MMRGBA(214, 222, 232, 1.0) : MMRGBA(255, 255, 255, 1.0));
}
...
static void MMUpdateNativeBackdrop(UIViewController *vc, UITabBar *tabBar) {
    ...
    if ([blur isKindOfClass:[UIVisualEffectView class]]) {
        if (MMIsDark(root.traitCollection)) {
            ((UIVisualEffectView *)blur).effect = [UIBlurEffect effectWithStyle:UIBlurEffectStyleSystemThinMaterialDark];
        } else {
    ...
    tint.backgroundColor = MMIsDark(root.traitCollection) ? MMRGBA(255, 255, 255, 0.001) : MMRGBA(255, 255, 255, 0.008);

    host.alpha = MMIsDark(root.traitCollection) ? 0.020 : 0.055;
...
static UIVisualEffectView *MMBlur(UIView *host) {
    ...
    blur.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:(MMIsDark(host.traitCollection) ? 0.06 : 0.10)];
...
static CGRect MMCapsuleFrame(UIView *host, NSInteger index, NSInteger count) {
    ...
    CGFloat targetWidth = MIN(CGRectGetWidth(slot) + 16.0, MAX(CGRectGetWidth(slot) + 10.0, targetHeight * 1.58));
...
static void MMStyleCapsule(UIView *host, NSInteger selectedIndex, NSInteger count) {
    ...
    UIView *glow = [capsule viewWithTag:kMMFloatingCapsuleGlowTag];
    glow.frame = CGRectInset(capsule.bounds, 2.0, 2.0);
...
static void MMApplyButtonSelectionLayout(UIView *container, UIView *host, UITabBar *tabBar, NSArray *originalItemViews, NSInteger selectedIndex, CGRect activeCapsuleFrame, BOOL useActiveCapsuleFrame) {
    ...
    for (NSInteger i = 0; i < count; i++) {
        ...
        if (i == selectedIndex) {
            ...
            button.mm_titleLabel.textColor = sourceTextColor ?: fallbackSelected;
        } else {
...
static void MMUpdateDockSearchButton(UIViewController *vc) {
    ...
    host.layer.borderWidth = 0.0;
    host.layer.shadowColor = [UIColor colorWithWhite:0.0 alpha:(MMIsDark(host.traitCollection) ? 0.022 : 0.008)].CGColor;
    host.layer.shadowOpacity = 1.0;
    ...
    CGFloat r = 1.0, g = 1.0, b = 1.0, a = 1.0;
    [tint getRed:&r green:&g blue:&b alpha:&a];
    blur.backgroundColor = [UIColor colorWithRed:r green:g blue:b alpha:(MMIsDark(host.traitCollection) ? 0.032 : 0.028)];
    ...
    icon.tintColor = MMIsDark(host.traitCollection) ? MMRGBA(255, 255, 255, 0.94) : MMRGBA(100, 104, 114, 0.86);
