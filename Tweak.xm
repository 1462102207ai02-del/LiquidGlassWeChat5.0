...
static void MMApplyLiquidGlassOverlay(UIView *view, BOOL capsuleStyle) {
    ...
    if (capsuleStyle) {
        overlayLayer.colors = @[
            ...
            (__bridge id)[UIColor colorWithRed:(232.0/255.0) green:(240.0/255.0) blue:(252.0/255.0) alpha:(MMIsDark(view.traitCollection) ? 0.05 : 0.12)].CGColor,
        ...
        overlayLayer.colors = @[
            (__bridge id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:(MMIsDark(view.traitCollection) ? 0.07 : 0.16)].CGColor,
            (__bridge id)[UIColor colorWithRed:(228.0/255.0) green:(238.0/255.0) blue:(252.0/255.0) alpha:(MMIsDark(view.traitCollection) ? 0.03 : 0.09)].CGColor,
...
static void MMApplyLiquidGlass(UIView *view, BOOL capsuleStyle) {
    ...
    if (capsuleStyle) {
        ...
        core.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:(dark ? 0.20 : 0.74)];
    } else {
        UIColor *bgTint = MMBackgroundTintColor(view.traitCollection);
        CGFloat r = 1.0, g = 1.0, b = 1.0, a = 1.0;
        [bgTint getRed:&r green:&g blue:&b alpha:&a];
        core.backgroundColor = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:(dark ? 0.28 : 0.92)];
    }
    ...
    if (capsuleStyle) {
        ...
        moving.colors = @[
            ...
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:(dark ? 0.09 : 0.18)].CGColor,
        ...
        topLine.colors = @[
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:0.0].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:(dark ? 0.28 : 0.70)].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:0.0].CGColor
        ];
        ...
        moving.colors = @[
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:0.0].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:(dark ? 0.15 : 0.27)].CGColor,
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:0.0].CGColor
        ];
        ...
        topLine.colors = @[
            (__bridge id)[UIColor colorWithWhite:1.0 alpha:(dark ? 0.30 : 0.78)].CGColor,
    ...
    CGFloat outerAlpha = dark ? 0.24 : 0.62;
    CGFloat innerAlpha = dark ? 0.22 : 0.22;
    CGFloat outerWidth = 1.02;
    CGFloat innerWidth = 0.24;
    if (capsuleStyle) {
        outerAlpha = dark ? 0.22 : 0.58;
        innerAlpha = dark ? 0.20 : 0.16;
        outerWidth = 0.94;
        innerWidth = 0.18;
    }
...
static void MMUpdateNativeBackdrop(UIViewController *vc, UITabBar *tabBar) {
    ...
    tint.backgroundColor = MMIsDark(root.traitCollection) ? MMRGBA(255, 255, 255, 0.002) : MMRGBA(255, 255, 255, 0.008);

    host.alpha = MMIsDark(root.traitCollection) ? 0.030 : 0.055;
...
static void MMUpdateDockSearchButton(UIViewController *vc) {
    ...
    CGFloat r = 1.0, g = 1.0, b = 1.0, a = 1.0;
    [tint getRed:&r green:&g blue:&b alpha:&a];
    blur.backgroundColor = [UIColor colorWithRed:r green:g blue:b alpha:(MMIsDark(host.traitCollection) ? 0.045 : 0.040)];
